	...
	<div id="menu">
		<?php
			...
			foreach ($menu_items as $menu_item) {
				...
				echo '<a href="?page='.$menu_item['URL'].'">'.$menu_item['Name'].'</a>'; // a-element
				echo"</li>\n";
			}
			echo"                </ul>";
	...
	<div id="user">
		<?php
			...
			if(isset($_SESSION['loggedin'])) {
				...
				echo '<li class="menu_item"><a href="?page=login.php&action=logoff">Afmelden</a></li>';
			} else {
				// maak loginmenu
				echo '<li class="menu_item"><a href="?page=login.php?action=login">Log in</a></li>';
			}
			echo '</ul>';
		?>
	</div>
